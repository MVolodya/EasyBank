namespace EasyBank.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EasyBank.Models.ConnectionContext>
    {
        ...
        protected override void Seed(EasyBank.Models.ConnectionContext context)
        {
            ...
            {
                new Client{Name="Borys", Surname="Symonenko", PIdNumber="1234567895", Email="symonenkob@gmail.com", BirthDate=DateTime.Parse("18.07.1995"), RegistrationDate=DateTime.Now, Accounts=new List<Account>()},
                new Client{Name="Ivan", Surname="Dontknow", PIdNumber="2234567895",Email="some@mail.com", BirthDate=DateTime.Parse("13.03.2000"), RegistrationDate=DateTime.Now, Accounts=new List<Account>()},
            ...
            {
                new Account{
                    AccountNumber="11356785", ExpirationDate=DateTime.MaxValue.Date, Amount=23444, ClientId=clients.First(c=>c.Surname=="Symonenko").ClientId,
                ...
                new Account{
                    AccountNumber="12454365", ExpirationDate=DateTime.MaxValue.Date, Amount=3453, ClientId=clients.First(c=>c.Surname=="Symonenko").ClientId,
                    TypeId=accoutTypes.First(t=>t.TypeName=="Deposit").TypeId, CurrencyId=currencies.First(c=>c.CurrencyName=="USD").CurrencyId, 
                    StatusId=accoutStatuses.First(s=>s.StatusName=="Normal").StatusId
                },
                new Account{
                    AccountNumber="21454465", ExpirationDate=DateTime.MaxValue.Date, Amount=2323, ClientId=clients.First(c=>c.Surname=="Dontknow").ClientId,
                ...
                new Account{
                    AccountNumber="31454365", ExpirationDate=DateTime.MaxValue.Date, Amount=6654, ClientId=clients.First(c=>c.Surname=="Nikonov").ClientId,
